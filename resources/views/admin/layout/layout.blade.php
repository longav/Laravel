        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark rounded" style="width: 280px;">
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                      <li class="nav-item">
                        <a href="{{route('list-product')}}" class="nav-link active" aria-current="page">
                          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"></use></svg>
                          Home
                        </a>
                      </li>
                      <li>
                        <a href="{{route('category.list-category')}}" class="nav-link text-white">
                          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
                          Category
                        </a>
                      </li>
                      <li>
                        <a href="{{route('oder.list-user')}}" class="nav-link text-white">
                      ...
                      <li>
                        <a href="
                        {{route('user.list-user')}}" class="nav-link text-white">
